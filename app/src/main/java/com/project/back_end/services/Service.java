...
public class Service {
    ...
    public int validateAppointment(Appointment appointment) {
        ...
        List<String> availableSlots = this.doctorService.getDoctorAvailability(
    ...
    public boolean validatePatient(Patient patient) {
        Patient existing = this.patientRepository.findByEmailOrPhone(patient.getEmail(), patient.getPhone());
        return existing == null;
    }

    public ResponseEntity<Map<String, String>> validatePatientLogin(Login login) {
        Map<String, String> response = new HashMap<>();
        Patient patient = this.patientRepository.findByEmail(login.getIdentifier());
    ...
    public ResponseEntity<Map<String, Object>> filterPatient(String condition, String name, String token) {
        ...
        if (condition != null && !condition.isEmpty() && (name == null || name.isEmpty())) {
            ...
            return this.patientService.filterByDoctorAndCondition(condition, name, patient.getId());
        } else {
            return this.patientService.getPatientAppointment(patient.getId(), token);
        }
    }
